...
theta11=zeros(size(Theta1));
theta22=zeros(size(Theta2));
i=1;
for j=1:size(Theta1,1)
theta11(j,i)=Theta1(j,i);
end
for j=1:size(Theta2,1)
theta22(j,i)=Theta2(j,i);
end
...
for i=1:m
for j=1:num_labels
J=J- Y(i,j)*log(z3(i,j)) - (1-Y(i,j))*log(1-(z3(i,j)));
end
end
J=J/m;
JR=0;
